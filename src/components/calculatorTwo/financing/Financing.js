                    ...
                    <Grid item xl={9} lg={9} md={9} sm={12} xs={12} style={{height:'80vh'}} >
                        ...
                        <Form.Row>
                                                    ...
                                                    <Form.Group as={Col}>
                                                        ...
                                                        <Form.Row>
                                                            <Form.Group as={Col} style={{margin:"0px 0px 5px !important"}}>
                                                            <Form.Control className={classes.inputtwo} type="text" placeholder="Years" /> 
                                                            </Form.Group>

                                                            <Form.Group as={Col} style={{margin:"0px 0px 5px !important"}}>
                                                            <Form.Control className={classes.inputtwo} type="text" placeholder="Months" />
                                                            </Form.Group>
                                                        </Form.Row>
