...
function ReportPdfOne(props) {
  console.log("pdf props", props.data);
  return (
      <>

    <PDFDownloadLink
          document={<ReportPdfOne  />}
              ...
              return (
                <View
                  ...
                  <View style={styles.movieDetails}>
                    <Text style={styles.movieTitle}> This is text </Text>
                    <View style={styles.subtitle}>
                      <View style={styles.vote}>
                        {/* <Image source="star.png" style={styles.rating} /> */}
                        <Text style={styles.vote_text}>This is text 2</Text>
                      </View>
                      <View style={styles.vote}>
